...
/**
 * `Record` sequencing, i.e., take a `Record` in which elements are monads and return a monad of a `Record` of the base
 * types. The following example for instance shows sequencing a `Record<string, Option<number>>` into an
 ...
 *   assert.deepStrictEqual(sRecord.concat({ a: 1, b: 2 }, { b: 3, c: 4 }), {
 *     a: 1,
 *     b: -1,
 *     c: 4,
 *   })
...
/**
 * Same as `getMonoid`. Returns a `Monoid` instance for `Record`s given a `Semigroup` instance for the base type. The
